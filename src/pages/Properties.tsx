...
const allProperties = [
  { image: penthouseInterior, title: "The Sovereign Penthouse", location: "Monte Carlo, Monaco", price: "€12,500,000", beds: 4, baths: 5, sqm: 420, tag: "Exclusive", type: "Penthouse", lat: 43.7384, lng: 7.4246 },
  { image: waterfrontVilla, title: "Villa Aquamarine", location: "Cap Ferrat, France", price: "€8,900,000", beds: 6, baths: 7, sqm: 680, tag: "Waterfront", type: "Villa", lat: 43.6846, lng: 7.3275 },
  { image: luxuryBuilding, title: "Obsidian Tower Residence", location: "Dubai Marina, UAE", price: "$5,200,000", beds: 3, baths: 4, sqm: 310, tag: "New Listing", type: "Apartment", lat: 25.0804, lng: 55.1403 },
  { image: luxuryInterior, title: "Maison de Lumière", location: "Saint-Tropez, France", price: "€7,400,000", beds: 5, baths: 6, sqm: 520, tag: "Signature Villa", type: "Villa", lat: 43.2727, lng: 6.6406 },
  { image: villaPool, title: "Horizon Estate", location: "Mykonos, Greece", price: "€4,200,000", beds: 4, baths: 4, sqm: 380, tag: "Investment", type: "Villa", lat: 37.4467, lng: 25.3289 },
  { image: luxuryKitchen, title: "The Gallery Loft", location: "London, UK", price: "£3,800,000", beds: 2, baths: 3, sqm: 240, type: "Apartment", lat: 51.5074, lng: -0.1278 },
  { image: penthouseInterior, title: "Pinnacle Sky Suite", location: "New York, USA", price: "$18,500,000", beds: 5, baths: 6, sqm: 550, tag: "Exclusive", type: "Penthouse", lat: 40.7580, lng: -73.9855 },
  { image: waterfrontVilla, title: "Casa del Mare", location: "Amalfi Coast, Italy", price: "€6,100,000", beds: 4, baths: 5, sqm: 450, tag: "Waterfront", type: "Villa", lat: 40.6333, lng: 14.6029 },
  { image: luxuryBuilding, title: "The Apex Residence", location: "Singapore", price: "$8,900,000", beds: 3, baths: 4, sqm: 320, type: "Apartment", lat: 1.2838, lng: 103.8591 },
];
            ...
            <ScrollReveal>
              <div className="mb-12 luxury-card overflow-hidden">
                <div className="relative w-full h-[400px] md:h-[500px] bg-secondary">
                  {/* World map SVG with property pins */}
                  <svg viewBox="0 0 1000 500" className="w-full h-full" preserveAspectRatio="xMidYMid meet">
                    ...
                    {/* Europe */}
                    <path d="M450,100 L480,90 L520,95 L540,110 L535,130 L550,140 L545,160 L530,170 L510,165 L490,175 L470,170 L460,155 L445,150 L440,130 L450,115 Z" 
                      fill="hsl(30 6% 18%)" stroke="hsl(38 50% 55% / 0.2)" strokeWidth="0.5" />
                    {/* Africa */}
                    <path d="M440,180 L480,175 L520,180 L540,200 L545,240 L540,280 L520,320 L500,340 L480,335 L460,300 L445,260 L435,220 L440,200 Z"
                      fill="hsl(30 6% 18%)" stroke="hsl(38 50% 55% / 0.2)" strokeWidth="0.5" />
                    {/* Asia */}
                    <path d="M550,80 L620,75 L700,85 L760,100 L780,130 L770,160 L740,180 L700,190 L660,185 L620,170 L580,160 L555,140 L545,120 Z"
                      fill="hsl(30 6% 18%)" stroke="hsl(38 50% 55% / 0.2)" strokeWidth="0.5" />
                    {/* North America */}
                    <path d="M100,80 L180,70 L250,80 L280,100 L290,130 L280,160 L250,180 L220,190 L180,185 L140,170 L110,150 L95,120 Z"
                      fill="hsl(30 6% 18%)" stroke="hsl(38 50% 55% / 0.2)" strokeWidth="0.5" />
                    {/* South America */}
                    <path d="M200,220 L240,210 L270,230 L280,270 L275,320 L260,360 L240,380 L220,375 L205,340 L195,300 L190,260 Z"
                      fill="hsl(30 6% 18%)" stroke="hsl(38 50% 55% / 0.2)" strokeWidth="0.5" />
                    {/* Australia */}
                    <path d="M750,280 L800,270 L840,280 L850,310 L840,340 L810,350 L780,340 L755,320 L745,300 Z"
                      fill="hsl(30 6% 18%)" stroke="hsl(38 50% 55% / 0.2)" strokeWidth="0.5" />
